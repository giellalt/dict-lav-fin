# Dictionary for lav — fin

This repository contains source files for a dictionary from Latvian to Finnish. The content is licensed under the CC-BY-4.0 license.
